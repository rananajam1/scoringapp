    ...
    return (
        <View style={styles.container}>
            <KeyboardAwareScrollView behavior="position" style={{flex:1}} >
                <Text style={{fontWeight: '800', fontSize: 25, color: '#01438D', marginLeft: 90, margin: 30}}>MATCH CENTER</Text>
                 
                <Text style={{fontSize: 20, textAlign: 'center', marginTop: 20, marginBottom: 10}}>Create your own match</Text>
                ...
                </Picker><Text style={{textAlign: 'center', color: '#507E14'}}>(Select Match Format)</Text>
                {format === 'OneDay' &&
