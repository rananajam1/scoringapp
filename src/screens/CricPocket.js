...
function CricPocket(props) {
  ...
  useEffect(() => {
    ...
    console.log({CricPocket: cricpocket})
  }, []);
    ...
    return (
        ...
        {cricpocket && cricpocket
        ?<View style={{flex:0.9}}>
          <View style={{flex: 0.3, flexDirection: 'row', justifyContent: 'flex-start', justifyContent: 'flex-start'}}>
            ...
            <View style={{flex: 0.3, justifyContent: 'flex-start', alignItems: 'center', marginTop:50}}>
            ...
            <View style={{flex: 1.5, alignItems:'center'}}>
              ...
              <View style={{ width: 200, height: 200, borderRadius: 200/2, backgroundColor: '#507E14', alignItems: 'center', justifyContent: 'center', margin:20}}>
                ...
                <Text style={{color: 'white', fontSize:48,}}>{cricpocket.balance} $</Text>
              </View>
            </View>
